        ...
        $.ajax({
            ...
            beforeSend: function () {
                if ($('button').attr('type') == 'button') {
                    ...
                    $('button').html('<span role="status" aria-hidden="true"><i class="bx bx-loader bx-spin"></i> Mohon tunggu... </span> ');
                }
            },
            ...
            success: function (data) {
                ...
                if(data.status =="success") {
                    alert.innerHTML = '<div class="alert alert-success alert-dismissible fade show" role="alert">' +
                        '<strong>Berhasil!</strong> Masuk ke halaman dashboard.' +
                        '</div>';
                        // loading
                      setTimeout(function () {
