      ...
      <div class="layout-container">
        ...
        >
          ...
          <ul class="menu-inner py-1">
            ...
            ?>">
              <a href="<?= BASEURL; ?>/transaksi" class="menu-link">
        ...
        <div class="layout-page">
          ...
          >
            ...
            >
              <!-- Search -->
              <h4 class="mb-0 w-100 text-center">DOSAKU</h4>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo $_SESSION['user']['nama']; ?></span>
